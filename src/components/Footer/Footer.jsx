    ...
    <footer className="highlands-footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-left">
          ...
          <p className="footer-copyright">©2025 Galaxy Cafe. All rights reserved</p>
        </div>
        ...
        <div className="footer-middle">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">{/* No sub-links visible in the image */}</ul>
          </div>
        </div>
        ...
        <div className="footer-right">
          ...
          <div className="footer-map">
            <iframe
              ...
              allowFullScreen
            />
            <a className="footer-map-link" href="https://maps.app.goo.gl/6RuUrqKaYAFspPe57" target="_blank" rel="noopener noreferrer">
